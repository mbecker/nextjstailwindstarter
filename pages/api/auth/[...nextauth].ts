          ...
          stravaAuthOptions.token = {
            ...
            async request(context) {
              ...
              try {
                ...
                //   meta = authData['meta'];
                // }
                // console.log(pocketBaseAuthData)
                // console.log('DONE ----------- ----------- -----------');
                return {
                  tokens: {
            ...
            async request(context) {
              ...
              context:  {
                "provider": {
                  ...
                  "authorization": {
                    ...
                    "params": {
                      "client_id": "5831",
                      "code_challenge": "LlizQ_P-FIcxppYzn_LH2H2Hd-I9jdAO6uphUon8nqM",
              ...
              pocketBaseAuthData: {
                "meta": {
                  ...
                  "token": {
                    "access_token": "aab3ba3f7b5d613ce6655b26124b8a46e3ef4cd5",
                    "token_type": "Bearer",
                    "refresh_token": "eabb7b6bbed69a668a744ded0f3612beb2bb8665",
                    "expiry": "2022-08-10T20:34:01.001937+02:00"
                  }
                },
                "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjEzNTMyOTEsImlkIjoiSmdWeHJDcXZsb3Zxdk1oIiwidHlwZSI6InVzZXIifQ.71RSqDxVtngNblOR3jygmWmnuK5tPuVXewSuBipkoBE",
                "user": {
                  "id": "JgVxrCqvlovqvMh",
                  "created": "2022-08-08 11:32:49.088",
                  "updated": "2022-08-08 11:32:49.088",
                  "email": "8844168@strava.com",
                  "verified": true,
                  "lastResetSentAt": "",
                  ...
                  "profile": {
                    "id": "UIcWYUqerqYczsX",
                    "created": "2022-08-08 11:32:49.088",
                    "updated": "2022-08-10 14:59:44.446",
                    "@collectionId": "rEJTd5iujp2798x",
                    "@collectionName": "profiles",
                    "avatar": "1g5AGBBPC51X94gagTigLaUPSWhWjWfD.jpg",
                    "name": "matsbecker",
                    "userId": "JgVxrCqvlovqvMh",
                    "@expand": {}
                  }
                }
              }
              */
              ...
              if (
                ...
                if (
                  typeof pocketBaseAuthData.user["profile"]["id"] !==
                  "undefined"
                ) {
                  profileId = pocketBaseAuthData.user["profile"]["id"];
                }
                if (
                  typeof pocketBaseAuthData.user["profile"]["name"] !==
                  "undefined"
                ) {
                ...
                if (
                  typeof pocketBaseAuthData.user["profile"]["avatar"] !==
                  "undefined"
                ) {
                  p.image = `${process.env.NEXT_PUBLIC_POCKETBASE_URL}/api/files/${pocketBaseAuthData.user.profile["@collectionId"]}/${profileId}/${pocketBaseAuthData.user["profile"]["avatar"]}`;
                  console.log(p.image);
              ...
              if (
                profileId !== null &&
                typeof pocketBaseAuthData["meta"] !== "undefined"
              ) {
                try {
                  const formData = new FormData();
                  let shouldUpdate: boolean = false;
                  if (typeof pocketBaseAuthData.meta["name"] !== "undefined") {
