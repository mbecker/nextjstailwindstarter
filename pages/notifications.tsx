...
const pageColor = { border: "border-teal-500", before: "before:bg-teal-500" };
  ...
  >
    <div className="sm:flex sm:items-start p-4">
      <div className="sm:flex-auto">
        ...
        >
          <span className="relative text-white">Notifications</span>
        </h1>
        <p className="mt-4 text-sm text-slate-600">A list of components</p>
      </div>
    ...
    <div className="mt-0">
      <div className="relative rounded-xl overflow-auto p-8">
        <div className="grid grid-cols-1 grid-flow-row gap-4 font-mono text-white text-sm text-center font-bold leading-6 bg-stripes-pink rounded-md">
          
          {
            colors.map((e, i) => (
                <div key={e} className={`p-4 rounded-md shadow-lg ${e} text-slate-600`}>
            {i} + {e}
          </div>
            ))
          }
